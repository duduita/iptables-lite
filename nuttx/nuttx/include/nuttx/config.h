...
#define CONFIG_EXAMPLES_IPLITE 1
#define CONFIG_EXAMPLES_IPLITE_PROGNAME "iplite"
#define CONFIG_EXAMPLES_IPLITE_PRIORITY 100
#define CONFIG_EXAMPLES_IPLITE_STACKSIZE 65536
